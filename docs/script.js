(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      footer_medical: "Fitness, nutrition, recovery, and pulse features are non-clinical heuristics for healthy individuals tracking performance, not medical advice. They do not apply to medical conditions (such as eating or sleep disorders).",
      ...
      support_hero_title: "Support & Contact for Train Libre",
      support_hero_copy: "If you have any questions, encounter issues, or want to report a bug in <strong>Train Libre</strong>, please reach out through one of our official developer support channels:",
      support_email_title: "Direct Email Support",
      support_email_copy: 'For personal or account-related inquiries, contact us directly at: <a href="mailto:support@schotte.me">support@schotte.me</a>',
      support_issues_title: "Issue Tracker & Community",
      support_issues_copy: 'Train Libre is Open Source. You can directly browse known bugs or submit technical issue reports on our GitHub Repository: <a href="https://github.com/rfivesix/train-libre/issues" target="_blank">Submit a Bug Report</a>',
      support_meta_title: "Expected Response Time",
      support_meta_copy: "We are fully committed to high software quality. All support requests via email are typically reviewed and answered within <strong>48 hours</strong>.",
      ...
      tos_toc_2: "2. As-Is Warranty Disclaimer",
      ...
      tos_p2_t: "2. As-Is Warranty Disclaimer",
      ...
      legal_version: "Version 1.7",
      legal_date: "7. August 2026 / August 7, 2026",
      ...
      p_last_updated: "As of: July 27, 2026",
      p_1_t: "1. Controller",
      ...
      p_2_l4: "<strong>No Commercial Tracking (Optional Pseudonymised Usage Statistics):</strong> Train Libre dispenses with advertising networks, commercial tracking, and behaviour profiling. A purely optional usage statistics integration (PostHog EU) is disabled by default, establishes no connection whatsoever before you consent, and transmits neither your names and content nor body measurements or nutritional values. See section 6 C for details.",
      ...
      p_6_t: "6. Data Security, Backups & Telemetry",
      ...
      footer_intelligent: "Intelligent Workouts",
      intel_work_hero_t: "Estimated 1-Rep Max (1RM)",
      intel_work_hero_c: "A safe strength progression heuristic that estimates maximum capabilities from submaximal resistance training sets.",
      intel_work_what_t: "What this system does",
      intel_work_what_l1: "Estimates maximum lift capacity (1RM) using the Epley equation.",
      intel_work_what_l2: "Restricts calculations to sets at or under 10 repetitions to preserve model accuracy.",
      intel_work_what_l3: "Provides a secure, on-device tracking model with local storage by default.",
      intel_work_what_l4: "Enables consistent monitoring of strength progress without testing failure.",
      intel_work_not_t: "What it does NOT do",
      intel_work_not_l1: "It does not measure actual physical or absolute failure thresholds.",
      intel_work_not_l2: "It cannot predict injury or validate structural joint safety limits.",
      intel_work_not_l3: "It is not a substitute for clinical diagnostics or athletic training supervision.",
      intel_work_how_t: "The Science of Estimated 1-Rep Max (1RM)",
      intel_work_how_c1: "Instead of testing true maximal capacity—which places substantial physical stress and injury risks on connective tissues—Train Libre computes estimated strength limits using the Epley equation.",
      intel_work_how_c2: "The Epley equation approximates 1RM using the submaximal weight lifted and completed repetitions: <span class=\"math-inline\">$1\\text{RM} \\approx w \\cdot \\left(1 + \\frac{r}{30}\\right)$</span>, which computes as <span class=\"math-inline\">$w \\cdot \\frac{36}{37 - r}$</span>.",
      intel_work_how_c3: "Peer-reviewed sports science research (e.g. Wood et al., 2002) compares linear and non-linear predictions, confirming that linear submaximal models are highly correlated with true 1RM for lower repetition sets (1–10 reps), keeping strength progression measurements safe and accessible.",
      intel_work_limits_t: "Why it is a guide, not a measurement",
      intel_work_limits_l1: "Subjectivity: Muscular performance fluctuates daily based on sleep quality, nutritional states, and nervous system fatigue. Treat estimations as directional guides.",
      intel_work_limits_l2: "Accuracy Decay: Estimates are disabled for sets exceeding 10 repetitions, as endurance and fatigue dynamics become non-linear beyond this range.",
      ...
      adapt_nut_macro_t: "From calories to macronutrients",
      adapt_nut_macro_c: "The calorie target is only half of the recommendation. Protein and fat are both set per kilogram of body weight and scaled with the goal; carbohydrates take whatever calories are left, because they are the macronutrient training performance is most sensitive to and the one there is most room to move.",
      adapt_nut_macro_l1: "Protein: 2.0 g/kg on a deficit, 1.8 g/kg at or above maintenance — the higher figure while cutting protects lean mass when energy is scarce.",
      adapt_nut_macro_l2: "Fat: 0.9 g/kg on a deficit, 1.0 g/kg at or above maintenance, inside the evidence-based ranges of 0.5–1.0 and 0.8–1.2 g/kg.",
      adapt_nut_macro_l3: "Floor: fat is never recommended below 0.6 g/kg. On a budget too small to carry the targets, fat gives way towards that floor before carbohydrates are emptied, and the recommendation is flagged as constrained.",
    ...
    de: {
      ...
      hero_copy: "Eine private, offline-fokussierte App für dein Workout-, Kalorien- und Körpergewicht-Tracking, die vollständig auf Werbung, Benutzerkonten und kommerzielles Tracking verzichtet.",
      hero_cta_ios: "App Store",
      hero_cta_android: "Android (Obtainium)",
      hero_cta_android_download: "Android (F-Droid)",
      nav_android_apk: "Android-APK",
      ...
      priv_copy: "Train Libre ist konsequent offline-first aufgebaut. Alle Daten verbleiben standardmäßig auf deinem Gerät, ganz ohne Cloud-Zwang, Werbung oder kommerzielles Tracking.",
      ...
      footer_medical: "Fitness-, Ernährungs-, Erholungs- und Pulsfunktionen sind nicht-klinische Heuristiken für gesunde Personen zur Leistungsmessung, keine medizinische Beratung. Sie gelten nicht bei Erkrankungen (wie Ess- oder Schlafstörungen).",
      ...
      support_hero_title: "Support & Kontakt für Train Libre",
      support_hero_copy: "Wenn Sie Fragen haben, auf Probleme stoßen oder einen Fehler in <strong>Train Libre</strong> melden möchten, wenden Sie sich bitte an einen unserer offiziellen Entwickler-Supportkanäle:",
      support_email_title: "Direkter E-Mail-Support",
      support_email_copy: 'Für persönliche oder kontobezogene Anfragen kontaktieren Sie uns direkt unter: <a href="mailto:support@schotte.me">support@schotte.me</a>',
      support_issues_title: "Fehlerverfolgung & Community",
      support_issues_copy: 'Train Libre ist Open Source. Sie können bekannte Fehler direkt durchsuchen oder technische Fehlerberichte in unserem GitHub-Repository einreichen: <a href="https://github.com/rfivesix/train-libre/issues" target="_blank">Fehlerbericht einreichen</a>',
      support_meta_title: "Erwartete Antwortzeit",
      support_meta_copy: "Wir setzen uns voll und ganz für eine hohe Softwarequalität ein. Alle Supportanfragen per E-Mail werden in der Regel innerhalb von <strong>48 Stunden</strong> geprüft und beantwortet.",
      ...
      p_last_updated: "Stand: 27. Juli 2026",
      ...
      p_6_t: "6. Datensicherheit, Backups & Telemetrie",
      ...
      footer_intelligent: "Intelligente Workouts",
      intel_work_hero_t: "Geschätztes 1-Repetition Maximum (1RM)",
      intel_work_hero_c: "Eine sichere Heuristik zur Kraftprogression, die maximale Kapazitäten aus submaximalen Krafttrainingssätzen schätzt.",
      intel_work_what_t: "Was dieses System tut",
      intel_work_what_l1: "Schätzt das maximale Bewegungsgewicht (1RM) unter Verwendung der Epley-Formel.",
      intel_work_what_l2: "Beschränkt die Berechnungen auf Sätze mit maximal 10 Wiederholungen, um die Modellgenauigkeit zu wahren.",
      intel_work_what_l3: "Bietet ein sicheres On-Device-Tracking-Modell mit standardmäßig lokaler Speicherung.",
      intel_work_what_l4: "Ermöglicht eine konsistente Überwachung des Kraftfortschritts ohne Verletzungsrisiko.",
      intel_work_not_t: "Was es NICHT tut",
      intel_work_not_l1: "Es misst keine tatsächlichen physischen oder absoluten Muskelversagensgrenzen.",
      intel_work_not_l2: "Es kann keine Verletzungen vorhersagen oder Gelenkbelastungsgrenzen validieren.",
      intel_work_not_l3: "Es ist kein Ersatz für klinische Diagnostik oder sportwissenschaftliche Betreuung.",
      intel_work_how_t: "Die Wissenschaft des geschätzten 1RM",
      intel_work_how_c1: "Anstatt die tatsächliche Maximalkraft zu testen – was eine erhebliche physische Belastung und ein Verletzungsrisiko für das Bindegewebe darstellt –, berechnet Train Libre geschätzte Kraftgrenzen mithilfe der Epley-Gleichung.",
      intel_work_how_c2: "Die Epley-Gleichung nähert das 1RM mithilfe des gehobenen Gewichts und der absolvierten Wiederholungen an: <span class=\"math-inline\">$1\\text{RM} \\approx w \\cdot \\left(1 + \\frac{r}{30}\\right)$</span>, was rechnerisch <span class=\"math-inline\">$w \\cdot \\frac{36}{37 - r}$</span> entspricht.",
      intel_work_how_c3: "Peer-Review-Studien der Sportwissenschaft (z.B. Wood et al., 2002) vergleichen lineare und nicht-lineare Vorhersagen und bestätigen, dass lineare submaximale Modelle hochgradig mit dem tatsächlichen 1RM für niedrigere Wiederholungszahlen (1–10 Wiederholungen) korrelieren.",
      intel_work_limits_t: "Warum es ein Richtwert ist, keine Messung",
      intel_work_limits_l1: "Subjektivität: Die Muskelleistung schwankt täglich je nach Schlafqualität, Ernährung und neuronaler Ermüdung. Nutzen Sie Schätzungen als Orientierungshilfe.",
      intel_work_limits_l2: "Genauigkeitsabfall: Schätzungen sind für Sätze mit mehr als 10 Wiederholungen deaktiviert, da die Ermüdungsdynamik in diesem Bereich nichtlinear wird.",
      ...
      adapt_nut_macro_t: "Von Kalorien zu Makronährstoffen",
      adapt_nut_macro_c: "Das Kalorienziel ist nur die halbe Empfehlung. Protein und Fett werden beide pro Kilogramm Körpergewicht festgelegt und mit dem Ziel skaliert; die Kohlenhydrate erhalten die verbleibenden Kalorien, da die Trainingsleistung auf sie am empfindlichsten reagiert und hier zugleich der größte Spielraum besteht.",
      adapt_nut_macro_l1: "Protein: 2,0 g/kg im Defizit, 1,8 g/kg im Erhalt oder Aufbau – der höhere Wert im Defizit schützt die fettfreie Masse, wenn Energie knapp ist.",
      adapt_nut_macro_l2: "Fett: 0,9 g/kg im Defizit, 1,0 g/kg im Erhalt oder Aufbau und damit innerhalb der evidenzbasierten Spannen von 0,5–1,0 bzw. 0,8–1,2 g/kg.",
      adapt_nut_macro_l3: "Untergrenze: Fett wird nie unter 0,6 g/kg empfohlen. Reicht das Kalorienbudget für die Zielwerte nicht aus, gibt Fett bis zu dieser Grenze nach, bevor die Kohlenhydrate geleert werden, und die Empfehlung wird als eingeschränkt markiert.",
    ...
    fr: {
      ...
      "footer_medical": "Les fonctions de fitness, nutrition, récupération et pouls sont des heuristiques non cliniques pour personnes en bonne santé, non des conseils médicaux. Elles ne s'appliquent pas aux troubles médicaux (troubles alimentaires/sommeil).",
      ...
      "support_hero_title": "Support & Contact pour Train Libre",
      "support_hero_copy": "Si vous avez des questions, rencontrez des problèmes ou souhaitez signaler un bug dans <strong>Train Libre</strong>, veuillez nous contacter via l'un de nos canaux de support officiels :",
      "support_email_title": "Support e-mail direct",
      "support_email_copy": 'Pour les demandes personnelles ou liées à votre compte, contactez-nous directement à l\'adresse : <a href="mailto:support@schotte.me">support@schotte.me</a>',
      "support_issues_title": "Suivi des bugs & Communauté",
      "support_issues_copy": 'Train Libre est Open Source. Vous pouvez directement consulter les bugs connus ou soumettre des rapports de bugs techniques sur notre dépôt GitHub : <a href="https://github.com/rfivesix/train-libre/issues" target="_blank">Soumettre un rapport de bug</a>',
      "support_meta_title": "Délai de réponse attendu",
      "support_meta_copy": "Nous sommes pleinement engagés à fournir des logiciels de haute qualité. Toutes les demandes d'assistance par e-mail sont généralement examinées et traitées sous <strong>48 heures</strong>.",
      ...
      "tos_toc_2": "2. Exclusion de garantie / Garantie « en l'état »",
      ...
      "tos_p2_t": "2. Exclusion de garantie / Garantie « en l'état »",
      ...
      "p_last_updated": "Dernière mise à jour : 27 juillet 2026",
      ...
      "p_5_a_l1": "<strong>Nombre de pas :</strong> Import des segments de pas enregistrés pour une évaluation hors ligne.",
      "p_5_a_l2": "<strong>Données de sommeil :</strong> Import des périodes et des phases de sommeil.",
      "p_5_a_l3": "<strong>Fréquence cardiaque :</strong> Import d'échantillons de pouls pour calculer des agrégations horaires locales.",
      "p_5_a_c2": "L'import sert exclusivement à l'affichage et à l'analyse locale au sein de Train Libre. Aucun transfert de ces données importées vers des serveurs externes n'a lieu.",
      ...
      "p_5_b_l1": "<strong>Mensurations corporelles :</strong> Export des mesures de poids.",
      "p_5_b_l2": "<strong>Nutrition et hydratation :</strong> Export des valeurs nutritionnelles consommées, des calories et des quantités d'eau.",
      "p_5_b_l3": "<strong>Séances d'entraînement :</strong> Export des séances terminées.",
      ...
      "p_6_t": "6. Sécurité des données, sauvegardes et télémétrie",
      ...
      "p_6_b_c1": "L'application propose des fonctions de sauvegarde de vos données afin de prévenir toute perte en cas de changement ou d'endommagement de l'appareil.",
      ...
      "p_6_b_l5": "5. <strong>Sauvegarde iCloud (iOS uniquement) :</strong> Train Libre propose une fonction de sauvegarde iCloud optionnelle sur iOS. Si vous l’activez, l’application synchronise automatiquement votre base de données locale vers votre dossier iCloud Drive personnel via l’infrastructure iCloud d’Apple. Cette fonction est strictly optionnelle et contrôlée exclusivement via votre identifiant Apple et les paramètres système iOS. Les données de sauvegarde sont chiffrées au repos et en transit par l’infrastructure iCloud d’Apple ; Train Libre ne stocke, n’héberge, ne traite ni n’a accès à vos fichiers de sauvegarde ou clés de chiffrement sur des serveurs externes. La confidentialité de vos données est régie par la politique de confidentialité iCloud d’Apple (https://www.apple.com/legal/privacy/).",
      "p_6_c_t": "C. Statistiques d'utilisation pseudonymisées optionnelles",
      "p_6_c_c1": "Train Libre propose une mesure d'utilisation purement optionnelle et respectueuse de la vie privée, destinée à améliorer la stabilité de l'application et l'usage des fonctionnalités, opérée via PostHog EU (https://eu.i.posthog.com). Dans l'application, la fonction est intitulée « Partager des statistiques d'utilisation anonymes ». PostHog associant des identifiants techniques aux événements transmis, il s'agit juridiquement de données pseudonymisées ; une anonymité complète ne peut être garantie pour des données techniques d'utilisation.",
      "p_6_c_l1": "1. <strong>Opt-in strict par défaut:</strong> La télémétrie est entièrement désactivée par défaut. Tant que vous n'avez pas expressément consenti, la bibliothèque de télémétrie n'est même pas initialisée. Aucun événement n'est transmis et aucune connexion réseau vers PostHog n'est établie — pas même une requête technique de configuration. Ce n'est qu'au moment où vous activez « Partager des statistiques d'utilisation anonymes » dans les Paramètres, sous Support &amp; Info, que l'application contacte PostHog pour la première fois. Un identifiant d'appareil aléatoire est certes généré localement dès le premier lancement, afin que le décompte des appareils actifs fonctionne à partir de votre consentement ; cette génération a lieu exclusivement sur votre appareil et sans aucune transmission.",
      "p_6_c_l2": "2. <strong>Étendue des événements collectés:</strong> Si vous avez consenti, seules les catégories suivantes sont collectées :<ul><li>Lancements de l'application (pour déterminer le nombre d'appareils actifs)</li><li>Écrans ouverts, identifiés uniquement par des identifiants techniques issus d'une liste figée dans le code source (par exemple diary_tab, live_workout)</li><li>Fonctions déclenchées, également au moyen d'identifiants fixes (par exemple routine_created, barcode_scanned)</li><li>Un compteur agrégé des entrées alimentaires enregistrées (le nombre ainsi que le mode de saisie, par exemple recherche, scan de code-barres ou reconnaissance par IA)</li><li>Indicateurs des séances d'entraînement terminées : nombre d'exercices, de séries et de minuteurs de repos, durée en minutes, ainsi que des indications par oui/non sur les fonctions d'entraînement utilisées. Le type de séance est transmis exclusivement sous la forme « routine » ou « custom », jamais sous forme de nom</li><li>Progression dans l'intégration initiale (numéro d'étape, nom de l'étape, temps passé)</li><li>Paramètres modifiés (identifiant du paramètre et nouvelle valeur)</li><li>État des requêtes IA de reconnaissance de repas (fournisseur choisi, succès ou code d'erreur, temps de réponse par plages larges telles que « 2-5s »)</li><li>État des migrations de base de données (version de départ et version cible, succès)</li><li>Indicateurs de l'estimation calorique adaptative : nombre d'entrées de poids et d'alimentation prises en compte, longueur de la fenêtre d'analyse, niveau de confiance et indicateurs de qualité — mais aucune valeur de poids, de calories ou d'objectif</li><li>Données techniques de contexte : version de l'application, build, système d'exploitation et sa version, plateforme, fuseau horaire, ainsi qu'une indication précisant si l'application s'exécute dans un émulateur</li></ul><p>Les compteurs tels que le nombre d'exercices ou de séries et la durée de l'entraînement sont transmis sous forme de valeurs numériques exactes et non de plages. Ces valeurs sont transmises sans nom, adresse e-mail ni identifiant d'appareil du fabricant. L'identification d'utilisateurs individuels n'est ni recherchée ni techniquement prévue.</p>",
      "p_6_c_l3": "3. <strong>Aucun contenu ni valeur de santé:</strong> Aucun nom, adresse e-mail, identifiant de compte ou identifiant d'appareil du fabricant n'est collecté, ni aucun contenu que vous saisissez — en particulier aucun titre de programme d'entraînement, nom d'exercice ou d'aliment, nom de recette, note ou texte libre. De même, aucune mensuration corporelle, aucun poids, aucune valeur calorique ou nutritionnelle n'est transmis. Tous les événements sont envoyés avec $ip : 0.0.0.0 ; les adresses IP ne sont pas conservées comme données d'événement et la résolution de localisation basée sur l'IP est expressément désactivée au moyen de $geoip_disable.",
      "p_6_c_l4": "4. <strong>Pays et langue:</strong> Afin d'analyser la répartition géographique de l'application, votre pays, votre continent et votre paramètre de langue sont transmis (par exemple « DE », « Europe », « de_DE »). Ces informations sont déduites sur votre appareil à partir de vos réglages système, et non de votre adresse IP. Aucune résolution jusqu'à la ville, la région, le code postal ou les coordonnées n'a lieu ; elle est désactivée côté serveur.",
      "p_6_c_l5": "5. <strong>Rapport de diagnostic volontaire:</strong> Dans la section Retour d'expérience, vous pouvez envoyer activement un rapport de diagnostic au développeur. Le rapport vous est présenté intégralement dans un aperçu avant l'envoi, et vous sélectionnez individuellement les sections incluses. Si vous le transmettez par e-mail, via le menu de partage, le presse-papiers ou l'export de fichier, il parvient directement au développeur sous votre propre contrôle et non par l'intermédiaire de PostHog. Pour l'envoi direct vers PostHog proposé en complément, le point 3 s'applique sans changement : votre note en texte libre, votre poids corporel ainsi que vos valeurs caloriques et de macronutriments ne sont pas transmis ; seules le sont des mesures techniques telles que le nombre d'entrées, les niveaux de confiance, les indicateurs de qualité et l'état de vos sauvegardes. L'envoi direct suppose un consentement actif au sens du point 1 ; si les statistiques d'utilisation sont désactivées, l'application vous en informe au lieu de signaler un envoi.",
      "p_6_c_l6": "6. <strong>Révocation et effacement:</strong> Vous pouvez retirer votre consentement à tout moment dans les Paramètres, ce qui interrompt immédiatement toute transmission. Le bouton « Supprimer les données de télémétrie » dans les Paramètres vous permet en outre de demander l'effacement des données associées à votre identifiant de télémétrie chez PostHog ; dans le même temps, tous les identifiants stockés localement sont réinitialisés. L'effacement peut faire l'objet d'exceptions techniques, par exemple pour les copies de sauvegarde. Un simple e-mail à feedback@schotte.me suffit également.",
      "p_6_c_l7": "7. <strong>Base légale:</strong> Le traitement des données de télémétrie repose exclusivement sur votre consentement explicite conformément à l'article 6, paragraphe 1, point a) du RGPD.",
      "p_6_c_l8": "8. <strong>Sous-traitant:</strong> PostHog, Inc. (2261 Market St., #4008, San Francisco, CA 94114, USA) agit en qualité de sous-traitant au sens de l'article 28 du RGPD. Un contrat de sous-traitance (Data Processing Agreement, DPA) a été conclu.",
      "p_6_c_l9": "9. <strong>Lieu de stockage, durée de conservation et transferts hors UE:</strong> Le projet PostHog EU utilisé s'appuie, comme infrastructure d'hébergement principale, sur des serveurs situés à Francfort-sur-le-Main, en Allemagne (AWS eu-central-1). Les données de télémétrie sont automatiquement supprimées après 12 mois au maximum. Selon les processus d'assistance, de sécurité et de sous-traitance ultérieure, des accès ou des traitements peuvent également avoir lieu en dehors de l'UE. De tels transferts sont couverts par les garanties appropriées convenues dans le contrat de sous-traitance, complétées par la certification au titre du EU-US Data Privacy Framework (DPF).",
      "p_6_c_l10": "10. <strong>Transparence complète:</strong> Le catalogue complet de tous les événements et des attributs transmis pour chacun d'eux est consultable publiquement dans le dépôt du code source, dans le fichier TELEMETRY.md. Les versions F-Droid et hors ligne sont compilées sans la bibliothèque de télémétrie et n'en contiennent pas le code.",
      "p_7_t": "7. Vos droits",
      ...
      "footer_intelligent": "Entraînements intelligents",
      "intel_work_hero_t": "Estimation du 1-Rep Max (1RM)",
      "intel_work_hero_c": "Une heuristique de progression de force sûre qui estime les capacités maximales à partir de séries d'entraînement sous-maximales.",
      "intel_work_what_t": "Ce que fait le système",
      "intel_work_what_l1": "Estime la charge maximale (1RM) en utilisant la formule d'Epley.",
      "intel_work_what_l2": "Limite les calculs aux séries de 10 répétitions ou moins pour préserver la précision.",
      "intel_work_what_l3": "Fournit un modèle de suivi sécurisé sur l'appareil avec stockage local par défaut.",
      "intel_work_what_l4": "Permet un suivi régulier de la progression de la force sans tester l'échec.",
      "intel_work_not_t": "Ce qu'il ne fait PAS",
      "intel_work_not_l1": "Il ne mesure pas les seuils physiques réels ou d'échec absolu.",
      "intel_work_not_l2": "Il ne peut pas prédire les blessures ni valider la sécurité articulaire.",
      "intel_work_not_l3": "Il ne remplace pas un diagnostic médical ou la supervision d'un entraîneur.",
      "intel_work_how_t": "La science du 1-Rep Max estimé (1RM)",
      "intel_work_how_c1": "Au lieu de tester la capacité maximale réelle, ce qui présente un risque de blessure et de stress articulaire, Train Libre calcule les limites de force estimées via l'équation d'Epley.",
      "intel_work_how_c2": "L'équation d'Epley estime le 1RM selon la charge et les répétitions : <span class=\"math-inline\">$1\\text{RM} \\approx w \\cdot \\left(1 + \\frac{r}{30}\\right)$</span>, calculé comme <span class=\"math-inline\">$w \\cdot \\frac{36}{37 - r}$</span>.",
      "intel_work_how_c3": "Des recherches évaluées par des pairs (ex. Wood et al., 2002) confirment que les modèles linéaires sous-maximaux sont fortement corrélés au 1RM réel pour les répétitions faibles (1 à 10 répétitions).",
      "intel_work_limits_t": "Pourquoi c'est un guide, pas une mesure",
      "intel_work_limits_l1": "Subjectivity: Les performances musculaires fluctuent selon le sommeil, la nutrition et la fatigue nerveuse. Traisez l'estimation comme un indicateur.",
      "intel_work_limits_l2": "Perte de précision: Les estimations sont désactivées pour les séries de plus de 10 répétitions, car la fatigue y devient non-linéaire.",
      ...
      "adapt_nut_macro_t": "Des calories aux macronutriments",
      "adapt_nut_macro_c": "L'objectif calorique n'est que la moitié de la recommandation. Les protéines et les lipides sont fixés par kilogramme de poids corporel et varient selon l'objectif ; les glucides reçoivent les calories restantes.",
      "adapt_nut_macro_l1": "Protéines : 2,0 g/kg en déficit, 1,8 g/kg à l'entretien ou en prise, afin de préserver la masse maigre quand l'énergie manque.",
      "adapt_nut_macro_l2": "Lipides : 0,9 g/kg en déficit, 1,0 g/kg à l'entretien ou en prise, dans les fourchettes de 0,5–1,0 et 0,8–1,2 g/kg.",
      "adapt_nut_macro_l3": "Plancher : jamais moins de 0,6 g/kg de lipides. Si le budget calorique est trop faible, les lipides descendent vers ce plancher avant que les glucides ne soient épuisés.",
    ...
    it: {
      ...
      "footer_medical": "Le funzioni per fitness, nutrizione, recupero e pulsazioni sono euristiche non cliniche per soggetti sani, non consigli medici. Non si applicano a condizioni mediche (come disturbi alimentari/sonno).",
      ...
      "support_hero_title": "Supporto & Contatti per Train Libre",
      "support_hero_copy": "Se hai domande, riscontri problemi o desideri segnalare un bug in <strong>Train Libre</strong>, ti preghiamo di contattarci tramite uno dei nostri canali di supporto ufficiali:",
      "support_email_title": "Supporto email diretto",
      "support_email_copy": 'Per richieste personali o relative all\'account, contattaci direttamente all\'indirizzo: <a href="mailto:support@schotte.me">support@schotte.me</a>',
      "support_issues_title": "Tracciamento dei problemi & Community",
      "support_issues_copy": 'Train Libre è Open Source. Puoi sfogliare direttamente i bug noti o inviare segnalazioni di problemi tecnici sulla nostra repository GitHub: <a href="https://github.com/rfivesix/train-libre/issues" target="_blank">Invia una segnalazione</a>',
      "support_meta_title": "Tempo di risposta previsto",
      "support_meta_copy": "Ci impegniamo al massimo per garantire un'elevata qualità del software. Tutte le richieste di supporto via email vengono solitamente esaminate e riscontrate entro <strong>48 ore</strong>.",
      ...
      "tos_toc_2": "2. Esclusione di garanzia / Garanzia «così com'è»",
      ...
      "tos_p2_t": "2. Esclusione di garanzia / Garanzia «così com'è»",
      ...
      "legal_version": "Versione 1.7",
      "legal_date": "7 agosto 2026",
      ...
      "p_last_updated": "Aggiornato al: 27 luglio 2026",
      ...
      "p_5_a_l1": "<strong>Conteggio passi:</strong> Importazione dei segmenti di passi registrati per la valutazione offline.",
      "p_5_a_l2": "<strong>Dati del sonno:</strong> Importazione degli intervalli e delle fasi del sonno.",
      "p_5_a_l3": "<strong>Frequenza cardiaca:</strong> Importazione di campioni di battito cardiaco per calcolare aggregazioni orarie locali.",
      "p_5_a_c2": "L'importazione serve esclusivamente alla visualizzazione e all'analisi locale all'interno di Train Libre. Non avviene alcun trasferimento di questi dati importati verso server esterni.",
      ...
      "p_5_b_l1": "<strong>Misure corporee:</strong> Esportazione delle misurazioni del peso.",
      "p_5_b_l2": "<strong>Alimentazione e idratazione:</strong> Esportazione dei valori nutrizionali consumati, delle calorie e delle quantità di acqua.",
      "p_5_b_l3": "<strong>Allenamenti:</strong> Esportazione delle sessioni di allenamento completate.",
      ...
      "p_6_t": "6. Sicurezza dei dati, backup e telemetria",
      ...
      "p_6_b_c1": "L'app offre funzioni per il backup dei vostri dati al fine di prevenire la perdita di dati in caso di sostituzione o danneggiamento del dispositivo.",
      ...
      "p_6_b_l5": "5. <strong>Backup iCloud (solo iOS):</strong> Train Libre offre una funzione opzionale di backup iCloud su iOS. Se abilitata, l’app sincronizza automaticamente il database locale nella cartella iCloud Drive personale tramite l’infrastruttura iCloud di Apple. Questa funzione è strettamente opzionale e controllata esclusivamente tramite l’ID Apple e le impostazioni di sistema iOS. I dati di backup sono crittografati a riposo e in transito dall’infrastruttura iCloud di Apple; Train Libre non archivia, ospita, elabora né ha accesso ai file di backup o alle chiavi di crittografia su server aziendali esterni. La privacy dei dati è disciplinata dall’Informativa sulla privacy iCloud di Apple (https://www.apple.com/legal/privacy/).",
      "p_6_c_t": "C. Statistiche d'uso pseudonimizzate opzionali",
      "p_6_c_c1": "Train Libre offre una rilevazione d'uso puramente opzionale e rispettosa della privacy, finalizzata a migliorare la stabilità dell'app e l'utilizzo delle funzionalità, gestita tramite PostHog EU (https://eu.i.posthog.com). Nell'app la funzione è denominata «Condividi statistiche d'uso anonime». Poiché PostHog associa identificativi tecnici agli eventi trasmessi, si tratta giuridicamente di dati pseudonimizzati; per i dati tecnici di utilizzo non è possibile garantire un anonimato completo.",
      "p_6_c_l1": "1. <strong>Opt-in rigoroso per impostazione predefinita:</strong> La telemetria è completamente disattivata per impostazione predefinita. Finché non prestate espressamente il consenso, la libreria di telemetria non viene nemmeno inizializzata. Non viene trasmesso alcun evento e non viene stabilita alcuna connessione di rete verso PostHog — nemmeno una richiesta tecnica di configurazione. Soltanto quando attivate «Condividi statistiche d'uso anonime» nelle Impostazioni, alla voce Supporto e Info, l'app contatta PostHog per la prima volta. Un identificativo casuale del dispositivo viene sì generato localmente già al primo avvio, affinché il conteggio dei dispositivi attivi funzioni a partire dal vostro consenso; tale generazione avviene esclusivamente sul vostro dispositivo e senza alcuna trasmissione.",
      "p_6_c_l2": "2. <strong>Ambito degli eventi rilevati:</strong> Se avete prestato il consenso, vengono rilevate esclusivamente le seguenti categorie:<ul><li>Avvii dell'app (per determinare il numero di dispositivi attivi)</li><li>Schermate aperte, identificate esclusivamente tramite identificativi tecnici tratti da un elenco fissato nel codice sorgente (ad esempio diary_tab, live_workout)</li><li>Funzioni attivate, parimenti tramite identificativi fissi (ad esempio routine_created, barcode_scanned)</li><li>Un contatore aggregato delle voci alimentari registrate (il numero nonché la modalità di inserimento, ad esempio ricerca, scansione del codice a barre o riconoscimento tramite IA)</li><li>Indicatori delle sessioni di allenamento concluse: numero di esercizi, serie e timer di recupero, durata in minuti nonché indicazioni sì/no sulle funzioni di allenamento utilizzate. Il tipo di sessione viene trasmesso esclusivamente come «routine» o «custom», mai come nome</li><li>Progressione nell'onboarding (numero del passaggio, denominazione del passaggio, tempo di permanenza)</li><li>Impostazioni modificate (identificativo dell'impostazione e nuovo valore)</li><li>Stato delle richieste IA per il riconoscimento dei pasti (fornitore selezionato, esito positivo o codice di errore, tempo di risposta in intervalli ampi quali «2-5s»)</li><li>Stato delle migrazioni del database (versione di partenza e di destinazione, esito)</li><li>Indicatori della stima calorica adattiva: numero di voci di peso e alimentazione considerate, ampiezza della finestra di osservazione, livello di confidenza e indicatori di qualità — ma nessun valore di peso, calorico o di obiettivo</li><li>Dati tecnici di contesto: versione dell'app, build, sistema operativo e relativa versione, piattaforma, fuso orario nonché un'indicazione sul fatto che l'app sia eseguita in un emulatore</li></ul><p>Contatori quali il numero di esercizi o di serie e la durata dell'allenamento vengono trasmessi come valori numerici esatti e non come intervalli. Tali valori vengono trasmessi senza nome, indirizzo e-mail o identificativo del dispositivo del produttore. L'identificazione di singoli utenti non è né intenzionale né tecnicamente prevista.</p>",
      "p_6_c_l3": "3. <strong>Nessun contenuto e nessun valore sanitario:</strong> Non vengono raccolti nomi, indirizzi e-mail, identificativi di account o identificativi del dispositivo del produttore, né alcun contenuto da voi inserito — in particolare nessun titolo di scheda di allenamento, nome di esercizio o di alimento, nome di ricetta, nota o testo libero. Parimenti non vengono trasmessi misure corporee, pesi, valori calorici o nutrizionali. Tutti gli eventi vengono inviati con $ip: 0.0.0.0; gli indirizzi IP non vengono memorizzati come dati dell'evento e la risoluzione della posizione basata sull'IP è espressamente disattivata mediante $geoip_disable.",
      "p_6_c_l4": "4. <strong>Paese e lingua:</strong> Per analizzare la diffusione geografica dell'app vengono trasmessi il vostro paese, il vostro continente e la vostra impostazione di lingua (ad esempio «DE», «Europa», «de_DE»). Tali indicazioni vengono derivate sul vostro dispositivo dalle impostazioni di sistema e non dal vostro indirizzo IP. Non avviene alcuna risoluzione a livello di città, regione, codice postale o coordinate; essa è disattivata lato server.",
      "p_6_c_l5": "5. <strong>Rapporto diagnostico volontario:</strong> Nella sezione Feedback potete inviare attivamente un rapporto diagnostico allo sviluppatore. Prima dell'invio il rapporto vi viene mostrato integralmente in un'anteprima e selezionate singolarmente le sezioni da includere. Se lo trasmettete via e-mail, tramite il menu di condivisione, gli appunti o l'esportazione su file, esso giunge direttamente allo sviluppatore sotto il vostro controllo e non tramite PostHog. Per l'invio diretto a PostHog offerto in aggiunta vale invariato il punto 3: la vostra nota in testo libero, il vostro peso corporeo nonché i vostri valori calorici e di macronutrienti non vengono trasmessi, bensì esclusivamente indicatori tecnici quali il numero di voci, i livelli di confidenza, gli indicatori di qualità e lo stato dei vostri backup. L'invio diretto presuppone un consenso attivo ai sensi del punto 1; se le statistiche d'uso sono disattivate, l'app ve lo segnala anziché comunicare un invio.",
      "p_6_c_l6": "6. <strong>Revoca e cancellazione:</strong> Potete revocare il consenso in qualsiasi momento nelle Impostazioni, interrompendo immediatamente ogni trasmissione. Tramite il pulsante «Elimina dati di telemetria» nelle Impostazioni potete inoltre richiedere la cancellazione presso PostHog dei dati collegati al vostro identificativo di telemetria; contestualmente vengono reimpostati tutti gli identificativi memorizzati localmente. La cancellazione può essere soggetta a eccezioni di natura tecnica, ad esempio per le copie di backup. In alternativa è sufficiente una semplice e-mail a feedback@schotte.me.",
      "p_6_c_l7": "7. <strong>Base giuridica:</strong> Il trattamento dei dati di telemetria avviene esclusivamente sulla base del vostro consenso esplicito ai sensi dell'art. 6, par. 1, lett. a) GDPR.",
      "p_6_c_l8": "8. <strong>Responsabile del trattamento:</strong> PostHog, Inc. (2261 Market St., #4008, San Francisco, CA 94114, USA) opera quale responsabile del trattamento ai sensi dell'art. 28 GDPR. È stato stipulato un accordo sul trattamento dei dati (Data Processing Agreement, DPA).",
      "p_6_c_l9": "9. <strong>Luogo di conservazione, durata e trasferimenti verso paesi terzi:</strong> Il progetto PostHog EU utilizzato impiega quale infrastruttura di hosting primaria server situati a Francoforte sul Meno, Germania (AWS eu-central-1). I dati di telemetria vengono cancellati automaticamente dopo un massimo di 12 mesi. A seconda dei processi di supporto, sicurezza e sub-responsabilità del trattamento, accessi o trattamenti possono avvenire anche al di fuori dell'UE. Per tali trasferimenti valgono le garanzie adeguate concordate nell'accordo sul trattamento dei dati, integrate dalla certificazione ai sensi dell'EU-US Data Privacy Framework (DPF).",
      "p_6_c_l10": "10. <strong>Trasparenza completa:</strong> Il catalogo completo di tutti gli eventi e delle caratteristiche trasmesse per ciascuno di essi è consultabile pubblicamente nel repository del codice sorgente, nel file TELEMETRY.md. Le build F-Droid e offline vengono compilate senza la libreria di telemetria e non ne contengono il codice.",
      ...
      "footer_intelligent": "Allenamenti intelligenti",
      "intel_work_hero_t": "Stima del Massimale (1RM)",
      "intel_work_hero_c": "Un'euristica per la progressione della forza che stima le capacità massime basandosi su serie di allenamento submassimali.",
      "intel_work_what_t": "Cosa fa il sistema",
      "intel_work_what_l1": "Stima il massimale (1RM) utilizzando l'equazione di Epley.",
      "intel_work_what_l2": "Limita i calcoli a serie pari o inferiori a 10 ripetizioni per preservare l'accuratezza.",
      "intel_work_what_l3": "Fornisce un modello di tracciamento locale sicuro sul dispositivo per impostazione predefinita.",
      "intel_work_what_l4": "Consente il monitoraggio costante dei progressi della forza senza testare il cedimento.",
      "intel_work_not_t": "Cosa NON fa",
      "intel_work_not_l1": "Non misura i reali limiti fisici o di cedimento assoluto.",
      "intel_work_not_l2": "Non può prevedere infortuni o convalidare limiti di sicurezza articolare.",
      "intel_work_not_l3": "Non sostituisce la diagnostica clinica o la supervisione di un allenatore.",
      "intel_work_how_t": "La scienza del massimale stimato (1RM)",
      "intel_work_how_c1": "Invece di testare la capacità massima reale, che espone a stress fisico e infortuni, Train Libre calcola i limiti di forza stimati usando l'equazione di Epley.",
      "intel_work_how_c2": "L'equazione di Epley approssima il 1RM usando il carico e le ripetizioni: <span class=\"math-inline\">$1\\text{RM} \\approx w \\cdot \\left(1 + \\frac{r}{30}\\right)$</span>, calcolato come <span class=\"math-inline\">$w \\cdot \\frac{36}{37 - r}$</span>.",
      "intel_work_how_c3": "Ricerche peer-reviewed (es. Wood et al., 2002) confermano che i modelli lineari submassimali sono altamente correlati al vero 1RM per le ripetizioni medio-basse (1-10 rep).",
      "intel_work_limits_t": "Perché è una guida, non una misura",
      "intel_work_limits_l1": "Soggettività: Le prestazioni variano in base al sonno, all'idratazione e alla fatica del sistema nervoso. Usare la stima come riferimento generale.",
      "intel_work_limits_l2": "Perdita di precisione: Le stime sono disabilitate per serie superiori a 10 ripetizioni, poiché la dinamica di fatica diventa non lineare.",
      ...
      "adapt_nut_macro_t": "Dalle calorie ai macronutrienti",
      "adapt_nut_macro_c": "L'obiettivo calorico è solo metà della raccomandazione. Proteine e grassi sono fissati per chilogrammo di peso corporeo e variano con l'obiettivo; i carboidrati ricevono le calorie rimanenti.",
      "adapt_nut_macro_l1": "Proteine: 2,0 g/kg in deficit, 1,8 g/kg a mantenimento o in massa, per preservare la massa magra quando l'energia scarseggia.",
      "adapt_nut_macro_l2": "Grassi: 0,9 g/kg in deficit, 1,0 g/kg a mantenimento o in massa, entro gli intervalli di 0,5–1,0 e 0,8–1,2 g/kg.",
      "adapt_nut_macro_l3": "Soglia minima: mai sotto 0,6 g/kg di grassi. Se il budget calorico non basta, i grassi scendono verso questa soglia prima che i carboidrati si azzerino.",
    ...
    ja: {
      ...
      "footer_medical": "フィットネス、栄養、回復、脈拍機能は健康な方向けの非臨床的なヒューリスティックであり、医療的助言ではありません。疾患（摂食障害や睡眠障害など）には適用されません。",
      ...
      "imp_title": "免責事項",
      "tos_title": "利用規約",
      "support_hero_title": "Train Libre サポート＆連絡先",
      "support_hero_copy": "質問がある場合、問題が発生した場合、または <strong>Train Libre</strong> のバグを報告したい場合は、公式の開発者サポートチャネルのいずれかからご連絡ください。",
      "support_email_title": "直接メールサポート",
      "support_email_copy": '個人またはアカウント関連のお問い合わせは、以下まで直接ご連絡ください: <a href="mailto:support@schotte.me">support@schotte.me</a>',
      "support_issues_title": "課題トラッカー＆コミュニティ",
      "support_issues_copy": 'Train Libreはオープンソースです。既知のバグを直接閲覧するか、GitHubリポジトリで技術的な問題報告を送信できます: <a href="https://github.com/rfivesix/train-libre/issues" target="_blank">バグ報告を送信</a>',
      "support_meta_title": "予想される応答時間",
      "support_meta_copy": "私たちは高いソフトウェア品質に全力を尽くしています。メールによるすべてのサポートリクエストは、通常 <strong>48時間</strong> 以内に確認され、返信されます。",
      "tos_hero_title": "利用規約 (v1.0)",
      "tos_hero_copy": "Train Libreのシンプルな利用規約。ローカルファースト、オープンソース、プライバシー尊重。",
      "tos_toc_title": "柱",
      "tos_toc_1": "1. 医療アドバイスの排除",
      "tos_toc_2": "2. 免責事項／現状有姿（As-Is）の保証否認",
      "tos_toc_3": "3. データの自主性",
      ...
      "tos_p2_t": "2. 免責事項／現状有姿（As-Is）の保証否認",
      ...
      "legal_version": "バージョン 1.7",
      "legal_date": "2026年8月7日",
      ...
      "p_last_updated": "最終更新日：2026年7月27日",
      "p_1_t": "1. データ管理者",
      ...
      "p_2_l4": "<strong>商用トラッキングなし（任意の仮名化利用統計）：</strong> Train Libre は、広告ネットワーク、商用トラッキング、行動プロファイリングを一切使用しません。完全に任意の利用統計（PostHog EU）はデフォルトで無効化されており、お客様の同意前にはいかなる接続も行わず、氏名や入力内容はもとより、身体測定値や栄養価も送信しません。詳細は第6項Cをご覧ください。",
      ...
      "p_5_a_l1": "<strong>歩数：</strong> オフラインでの評価のために、記録された歩数セグメントを取り込みます。",
      "p_5_a_l2": "<strong>睡眠データ：</strong> 睡眠時間帯および睡眠段階を取り込みます。",
      "p_5_a_l3": "<strong>心拍数：</strong> ローカルでの1時間ごとの集計を算出するために心拍数サンプルを取り込みます。",
      "p_5_a_c2": "取り込んだデータは、Train Libre 内での表示およびローカル分析のみに使用されます。これらのデータが外部サーバーへ送信されることはありません。",
      "p_5_b_t": "B. データ書き込み",
      "p_5_b_c1": "ユーザーの要求に応じて、記録した体重、食事、ワークアウトをシステム健康データベースに書き出します。",
      "p_5_b_l1": "<strong>身体測定値：</strong> 体重の測定値を書き出します。",
      "p_5_b_l2": "<strong>栄養と水分補給：</strong> 摂取した栄養素、カロリーおよび水分量を書き出します。",
      "p_5_b_l3": "<strong>ワークアウト：</strong> 完了したトレーニングセッションを書き出します。",
      "p_5_b_c2": "<strong>重複防止：</strong> 重複登録を防ぐためのIDログはデバイス内のみに保存されます。",
      "p_6_t": "6. データセキュリティ、バックアップおよびテレメトリ",
      "p_6_c1": "すべてのデータがローカルに保存されるため、デバイス自体のセキュリティが重要です。",
      "p_6_a_t": "A. データ隔離",
      "p_6_a_c1": "OSはアプリをサンドボックスで保護しており、他のアプリがSQLiteデータベースやAPIキーに直接アクセスすることはできません。",
      "p_6_b_t": "B. バックアップ",
      "p_6_b_c1": "本アプリは、端末の機種変更や破損によるデータ喪失を防ぐため、データをバックアップする機能を提供しています。",
      ...
      "p_6_b_l5": "5. <strong>iCloudバックアップ（iOSのみ）：</strong> Train LibreはiOS上でオプションのiCloudバックアップ機能を提供しています。有効にすると、アプリはローカルデータベースをAppleのiCloudインフラを介して個人のiCloud Driveフォルダに自動同期します。この機能は完全にオプトイン式であり、Apple IDおよびiOSシステム設定によってのみ制御されます。バックアップデータはAppleのiCloudインフラによって保存時および転送時に暗号化されます。Train Libreは外部サーバー上にバックアップファイルや暗号化キーを保存、ホスト、処理、またはアクセスすることはありません。この機能のデータプライバシーはAppleのiCloudプライバシーポリシー（https://www.apple.com/legal/privacy/）に従います。",
      "p_6_c_t": "C. 任意の仮名化利用統計",
      "p_6_c_c1": "Train Libre は、アプリの安定性および機能利用状況の改善を目的として、完全に任意でプライバシーに配慮した利用統計機能を提供しています。運用は PostHog EU（https://eu.i.posthog.com）を通じて行われます。アプリ内では本機能を「匿名の利用統計を共有する」と表示しています。PostHog は送信されたイベントに技術的な識別子を付与するため、法的には仮名化データに該当します。技術的な利用データについて完全な匿名性を保証することはできません。",
      "p_6_c_l1": "1. <strong>厳格なオプトイン方式:</strong> テレメトリはデフォルトで完全に無効化されています。お客様が明示的に同意されるまで、テレメトリ用のライブラリは初期化すらされません。イベントが送信されることはなく、PostHog へのネットワーク接続も確立されません。技術的な構成情報の取得要求も行いません。「設定」の「サポート＆情報」で「匿名の利用統計を共有する」を有効にして初めて、アプリは PostHog に接続します。なお、同意後ただちにアクティブ端末数の集計が機能するよう、ランダムな端末識別子は初回起動時にローカルで生成されますが、この生成はお客様の端末内でのみ行われ、いかなる送信も伴いません。",
      "p_6_c_l2": "2. <strong>収集されるイベントの範囲:</strong> 同意された場合に限り、以下のカテゴリーのみが収集されます。<ul><li>アプリの起動（アクティブな端末数の把握のため）</li><li>開かれた画面。ソースコード内で固定された一覧にある技術的な識別子のみを用います（例：diary_tab、live_workout）</li><li>実行された機能。同様に固定の識別子を用います（例：routine_created、barcode_scanned）</li><li>記録された食事エントリーの集計カウンター（件数および検索、バーコードスキャン、AI 認識といった記録方法）</li><li>完了したトレーニングの指標：種目数、セット数、レストタイマー数、分単位の所要時間、および使用したトレーニング機能の有無。トレーニングの種別は「routine」または「custom」としてのみ送信され、名称が送信されることはありません</li><li>オンボーディングの進捗（ステップ番号、ステップ名称、滞在時間）</li><li>変更された設定（設定の識別子および新しい値）</li><li>食事認識に関する AI リクエストの状態（選択したプロバイダー、成功またはエラーコード、「2-5s」のような粗い区分による応答時間）</li><li>データベース移行の状態（移行元および移行先のバージョン、成否）</li><li>適応型カロリー推定の指標：対象とした体重および食事の記録件数、評価期間の長さ、確信度および品質指標。ただし体重、カロリーまたは目標の数値は含みません</li><li>技術的な環境情報：アプリのバージョン、ビルド番号、OS およびそのバージョン、プラットフォーム、タイムゾーン、ならびにエミュレーターで実行されているかどうかの情報</li></ul><p>種目数やセット数、トレーニング時間などのカウンターは、区分ではなく正確な数値として送信されます。これらの数値は、氏名、メールアドレス、メーカーの端末識別子を伴わずに送信されます。個々の利用者を特定することは意図しておらず、技術的にも想定していません。</p>",
      "p_6_c_l3": "3. <strong>入力内容および健康数値の不収集:</strong> 氏名、メールアドレス、アカウント識別子、メーカーの端末識別子は収集されません。お客様が入力された内容、とりわけトレーニングプラン名、種目名、食品名、レシピ名、メモや自由記述文も収集されません。同様に、身体測定値、体重、カロリーおよび栄養素の数値も送信されません。すべてのイベントは $ip: 0.0.0.0 を付して送信され、IP アドレスはイベントデータとして保存されず、IP に基づく位置情報の解決は $geoip_disable により明示的に無効化されています。",
      "p_6_c_l4": "4. <strong>国および言語:</strong> アプリの地理的な利用分布を分析するため、お客様の国、大陸および言語設定（例：「DE」「ヨーロッパ」「de_DE」）が送信されます。これらの情報は IP アドレスからではなく、お客様の端末上でシステム設定から導出されます。市区町村、地域、郵便番号または座標への解決は行われず、サーバー側でも無効化されています。",
      "p_6_c_l5": "5. <strong>任意の診断レポート:</strong> 「フィードバック」の画面から、診断レポートを開発者へ能動的に送信することができます。レポートは送信前にプレビューで全文が表示され、含める項目を個別に選択できます。メール、共有機能、クリップボードまたはファイル書き出しにより送信する場合、レポートはお客様自身の管理のもとで開発者へ直接届き、PostHog を経由しません。追加で提供している PostHog への直接送信については第3項がそのまま適用されます。すなわち、自由記述のメモ、体重、カロリーおよびマクロ栄養素の数値は送信されず、記録件数、確信度、品質指標、バックアップの状態といった技術的な指標のみが送信されます。直接送信には第1項に基づく有効な同意が必要であり、利用統計が無効な場合、アプリは送信済みと表示するのではなく、その旨をお知らせします。",
      "p_6_c_l6": "6. <strong>撤回および削除:</strong> 同意はいつでも設定画面で撤回でき、撤回により送信は直ちに停止します。さらに、設定画面の「テレメトリデータを削除」から、お客様のテレメトリ識別子に紐づくデータの PostHog における削除を請求できます。同時に、ローカルに保存されたすべての識別子がリセットされます。削除にはバックアップの複製など技術上の例外が生じる場合があります。feedback@schotte.me への簡単なメールによる請求も可能です。",
      "p_6_c_l7": "7. <strong>法的根拠:</strong> テレメトリデータの処理は、GDPR 第6条1項(a)に基づくお客様の明示的な同意のみを法的根拠として行われます。",
      "p_6_c_l8": "8. <strong>処理者:</strong> PostHog, Inc.（2261 Market St., #4008, San Francisco, CA 94114, USA）が GDPR 第28条にいう処理者として関与します。データ処理契約（Data Processing Agreement, DPA）を締結しています。",
      "p_6_c_l9": "9. <strong>保存場所、保存期間および第三国への移転:</strong> 利用している PostHog EU プロジェクトは、主たるホスティング基盤としてドイツ・フランクフルト・アム・マインのサーバー（AWS eu-central-1）を使用しています。テレメトリデータは最長12か月で自動的に削除されます。サポート、セキュリティおよび再委託処理の各プロセスに応じて、EU 域外でのアクセスまたは処理が生じる場合があります。かかる移転については、データ処理契約において合意された適切な保護措置が適用され、EU-US Data Privacy Framework（DPF）に基づく認証がこれを補完します。",
      "p_6_c_l10": "10. <strong>完全な透明性:</strong> すべてのイベントおよび各イベントで送信される項目の完全な一覧は、ソースコードリポジトリ内の TELEMETRY.md にて公開されています。F-Droid 版およびオフライン版のビルドはテレメトリライブラリを含まずにコンパイルされ、当該コードを含みません。",
      "p_7_t": "7. データ主体の権利",
      ...
      "p_7_l_telemetry": "<strong>テレメトリデータに関する権利：</strong> 匿名テレメトリに同意した場合、feedback@schotte.me 宛てにデータ管理者へ連絡することで、処理されたテレメトリデータに関する権利（開示、消去、異議申し立て）を行使できます。要請に応じ、PostHogのサーバーからすべてのテレメトリイベントが消去されます。",
      ...
      "footer_intelligent": "インテリジェントワークアウト",
      "intel_work_hero_t": "推定1レップマックス (1RM)",
      "intel_work_hero_c": "サブマキシマル（最大未満）のレジスタンストレーニングセットから最大挙上重量を推定する、安全な筋力向上ヒューリスティック。",
      "intel_work_what_t": "このシステムができること",
      "intel_work_what_l1": "Epley公式を用いて最大挙上重量（1RM）を推定します。",
      "intel_work_what_l2": "モデルの精度を保つため、計算対象を10レップ以下のセットに制限します。",
      "intel_work_what_l3": "デフォルトでローカルストレージを使用し、デバイス上で安全に追跡します。",
      "intel_work_what_l4": "限界まで挙上することなく、安全かつ継続的に筋力向上をモニタリングできます。",
      "intel_work_not_t": "このシステムができないこと",
      "intel_work_not_l1": "実際の身体的な限界値や絶対的な挙上限界を直接測定するものではありません。",
      "intel_work_not_l2": "怪我の予測や、関節等の構造的な安全限界を検証することはできません。",
      "intel_work_not_l3": "臨床的な診断や専門の指導者の代わりとなるものではありません。",
      "intel_work_how_t": "推定1RMの科学的背景",
      "intel_work_how_c1": "結合組織に多大な負担をかけ、怪我のリスクを伴う実際の最大挙上テストを行う代わりに、Train LibreはEpley方程式を用いて推定筋力限界を計算します。",
      "intel_work_how_c2": "Epley公式は挙上重量とレップ数から1RMを近似します: <span class=\"math-inline\">$1\\text{RM} \\approx w \\cdot \\left(1 + \\frac{r}{30}\right)$</span>（計算上は <span class=\"math-inline\">$w \\cdot \\frac{36}{37 - r}$</span> となります）。",
      "intel_work_how_c3": "査読付きスポーツ科学研究（例: Woodら、2002年）は、線形および非線形予測モデルを比較し、低レップ（1〜10レップ）のセットにおける線形推定モデルが実際の1RMと非常に高く相関することを確認しています。",
      "intel_work_limits_t": "測定値ではなく目安である理由",
      "intel_work_limits_l1": "主観性: 筋力パフォーマンスは睡眠、栄養、神経系疲労などにより日々変動します。推定値は絶対的なルールではなく指標として扱ってください。",
      "intel_work_limits_l2": "精度の低下: レップ数が10を超えると疲労力学が非線形になるため、10レップを超えるセットについてはアプリ上での推定計算は無効化されます。",
      ...
      "adapt_nut_macro_t": "カロリーからマクロ栄養素へ",
      "adapt_nut_macro_c": "カロリー目標は推奨の半分にすぎません。タンパク質と脂質はいずれも体重1kgあたりで設定され、目標に応じて変化します。炭水化物は残りのカロリーを受け取ります。",
      "adapt_nut_macro_l1": "タンパク質：減量期は2.0g/kg、維持・増量期は1.8g/kg。エネルギーが不足する減量期に除脂肪量を守ります。",
      "adapt_nut_macro_l2": "脂質：減量期は0.9g/kg、維持・増量期は1.0g/kg。エビデンスに基づく0.5〜1.0および0.8〜1.2g/kgの範囲内です。",
      "adapt_nut_macro_l3": "下限：脂質は0.6g/kgを下回りません。カロリーが足りない場合は、炭水化物を使い切る前に脂質がこの下限まで下がり、推奨は制約付きとして表示されます。",
