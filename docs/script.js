(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      legal_version: "Version 1.5",
      legal_date: "23. Juli 2026 / July 23, 2026",
    ...
    fr: {
      ...
      "p_6_b_l5": "5. <strong>Sauvegarde iCloud (iOS uniquement) :</strong> Train Libre propose une fonction de sauvegarde iCloud optionnelle sur iOS. Si vous l’activez, l’application synchronise automatiquement votre base de données locale vers votre dossier iCloud Drive personnel via l’infrastructure iCloud d’Apple. Cette fonction est strictement optionnelle et contrôlée exclusivement via votre identifiant Apple et les paramètres système iOS. Les données de sauvegarde sont chiffrées au repos et en transit par l’infrastructure iCloud d’Apple ; Train Libre ne stocke, n’héberge, ne traite ni n’a accès à vos fichiers de sauvegarde ou clés de chiffrement sur des serveurs externes. La confidentialité de vos données est régie par la politique de confidentialité iCloud d’Apple (https://www.apple.com/legal/privacy/).",
      "p_7_t": "7. Vos droits",
    ...
    it: {
      ...
      "legal_version": "Versione 1.5",
      "legal_date": "23 luglio 2026",
