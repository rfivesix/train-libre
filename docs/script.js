(() => {
  ...
  const TRANSLATIONS = {
    en: {
      ...
      legal_version: "Version 1.6",
      legal_date: "27. Juli 2026 / July 27, 2026",
      ...
      p_6_c_t: "C. Optional Anonymous Telemetry",
      p_6_c_c1: "Train Libre includes an optional, privacy-focused usage metrics integration powered by PostHog EU (https://eu.i.posthog.com).",
      p_6_c_l1: "1. <strong>Strict Opt-In Default:</strong> Telemetry is disabled by default. No telemetry data or network requests are transmitted unless you explicitly opt in by toggling \"Share anonymous usage statistics\" to ON in Settings under Support & Info.",
      p_6_c_l2: "2. <strong>Zero Personally Identifiable Information (PII):</strong> Telemetry captures zero personal identifiers, user names, email addresses, IP addresses, body weights, set reps, or food item titles. IP addresses are discarded upon ingestion.",
      p_6_c_l3: "3. <strong>Coarse Aggregated Buckets:</strong> Event metrics are exclusively grouped into coarse, non-identifiable ranges (e.g., app version, OS platform, coarse workout duration buckets like 15-30min, exercise count ranges like 4-7, AI request latency buckets, and schema migration status).",
      p_6_c_l4: "4. <strong>Instant Revocation:</strong> You can withdraw your consent and disable telemetry at any time in Settings, which immediately halts all event transmissions.",
      p_6_c_l5: "5. <strong>Legal Basis:</strong> The processing of telemetry data is based exclusively on your explicit consent pursuant to Article 6(1)(a) of the GDPR.",
      p_6_c_l6: "6. <strong>Data Processor:</strong> PostHog, Inc. (2261 Market St., #4008, San Francisco, CA 94114, USA) acts as data processor pursuant to Article 28 of the GDPR. A Data Processing Agreement (DPA) is in place.",
      p_6_c_l7: "7. <strong>Storage Location, Retention & US Transfer Safeguards:</strong> Telemetry data is stored exclusively on EU-based infrastructure (AWS eu-central-1, Frankfurt, Germany) and retained for a maximum of 12 months, after which it is automatically deleted. While all primary storage remains strictly within the EU, technical support access by PostHog, Inc. may occur under the safeguards of the EU-US Data Privacy Framework (DPF).",
    ...
    de: {
      ...
      p_6_c_t: "C. Optionale anonyme Telemetrie",
      p_6_c_c1: "Train Libre bietet eine rein optionale, datenschutzfreundliche Nutzungsstatistik zur Verbesserung der App-Stabilität und Feature-Nutzung an, betrieben über PostHog EU (https://eu.i.posthog.com).",
      p_6_c_l1: "1. <strong>Strikter Opt-In-Standard:</strong> Die Telemetrie ist standardmäßig vollständig deaktiviert. Es werden keinerlei Daten oder Netzwerkverbindungen aufgebaut, bevor Sie die Funktion nicht ausdrücklich in den Einstellungen unter Support & Info durch Aktivieren von „Anonyme Nutzungsstatistiken teilen“ einschalten.",
      p_6_c_l2: "2. <strong>Keine personenbezogenen Daten (Zero PII):</strong> Es werden keinerlei persönliche Identifikatoren, Namen, E-Mail-Adressen, IP-Adressen, Körpergewichte, Übungs-Wiederholungen oder Mahlzeitennamen erfasst. IP-Adressen werden unmittelbar bei der Verarbeitung verworfen.",
      p_6_c_l3: "3. <strong>Grobe aggregierte Buckets:</strong> Erfasste Metriken werden ausschließlich in grobe, nicht-identifizierbare Bereiche zusammengefasst (z. B. App-Version, Betriebssystem-Plattform, grobe Workout-Dauerbereiche wie 15-30min, Übungsanzahl-Bereiche wie 4-7, KI-Anfrage-Latenzbereiche sowie Schema-Migrationsstatus).",
      p_6_c_l4: "4. <strong>Jederzeitiger Widerruf:</strong> Sie können Ihre Zustimmung jederzeit in den Einstellungen widerrufen, wodurch alle Übertragungen sofort gestoppt werden.",
      p_6_c_l5: "5. <strong>Rechtsgrundlage:</strong> Die Verarbeitung von Telemetriedaten erfolgt ausschließlich auf Grundlage Ihrer ausdrücklichen Einwilligung gemäß Art. 6 Abs. 1 lit. a DSGVO.",
      p_6_c_l6: "6. <strong>Auftragsverarbeiter:</strong> Als Auftragsverarbeiter gemäß Art. 28 DSGVO fungiert die PostHog, Inc. (2261 Market St., #4008, San Francisco, CA 94114, USA). Ein Vertrag zur Auftragsverarbeitung (Data Processing Agreement, DPA) wurde geschlossen.",
      p_6_c_l7: "7. <strong>Speicherort, Speicherdauer & US-Zugriffe:</strong> Telemetriedaten werden ausschließlich auf EU-basierten Servern (AWS eu-central-1, Frankfurt am Main, Deutschland) gespeichert und nach maximal 12 Monaten automatisch gelöscht. Während alle Daten in der EU verbleiben, erfolgen eventuelle Fernzugriffe für technischen Support durch PostHog, Inc. auf Grundlage geeigneter Garantien unter dem EU-US Data Privacy Framework (DPF).",
    ...
    fr: {
      ...
      "p_6_c_t": "C. Télémétrie anonyme optionnelle",
      "p_6_c_c1": "Train Libre intègre une mesure d'utilisation optionnelle et respectueuse de la vie privée, propulsée par PostHog EU (https://eu.i.posthog.com).",
      "p_6_c_l1": "1. <strong>Opt-In strict par défaut :</strong> La télémétrie est entièrement désactivée par défaut. Aucune donnée ni requête réseau n'est transmise tant que vous n'activez pas explicitement l'option \"Partager des statistiques d'utilisation anonymes\" dans les Paramètres sous Support & Info.",
      "p_6_c_l2": "2. <strong>Zéro donnée directement identifiable (Zero PII) :</strong> La télémétrie ne collecte aucun identifiant personnel, nom, adresse e-mail, adresse IP, poids corporel, répétition d'exercice ni nom d'aliment. Les adresses IP sont immédiatement supprimées lors de la collecte.",
      "p_6_c_l3": "3. <strong>Intervalles d'agrégation approximatifs :</strong> Les données d'événement sont exclusivement regroupées sous forme d'intervalles approximatifs non identifiables (par ex. version de l'application, plateforme système, plages de durée d'entraînement comme 15-30 min, nombre d'exercices comme 4-7, temps de réponse IA et statut de migration de base de données).",
      "p_6_c_l4": "4. <strong>Révocation immédiate :</strong> Vous pouvez retirer votre consentement et désactiver la télémétrie à tout moment dans les Paramètres, ce qui interrompt immédiatement toute transmission.",
      "p_6_c_l5": "5. <strong>Base légale :</strong> Le traitement des données de télémétrie repose exclusivement sur votre consentement explicite conformément à l'article 6, paragraphe 1, point a) du RGPD.",
      "p_6_c_l6": "6. <strong>Sous-traitant :</strong> PostHog, Inc. (2261 Market St., #4008, San Francisco, CA 94114, USA) agit en qualité de sous-traitant conformément à l'article 28 du RGPD. Un contrat de traitement des données (DPA) est conclu.",
      "p_6_c_l7": "7. <strong>Lieu de stockage, durée de conservation et garanties de transfert :</strong> Les données de télémétrie sont stockées exclusivement sur une infrastructure basée dans l'UE (AWS eu-central-1, Francfort, Allemagne) et conservées pendant une durée maximale de 12 mois, après quoi elles sont automatiquement supprimées. Bien que le stockage principal reste strictly dans l'UE, des accès d'assistance technique par PostHog, Inc. peuvent intervenir sous les garanties du EU-US Data Privacy Framework (DPF).",
      "p_7_t": "7. Vos droits",
    ...
    it: {
      ...
      "legal_version": "Versione 1.6",
      "legal_date": "27 luglio 2026",
      ...
      "p_6_c_t": "C. Telemetria anonima opzionale",
      "p_6_c_c1": "Train Libre include un'integrazione opzionale per metriche d'uso orientata alla privacy, gestita tramite PostHog EU (https://eu.i.posthog.com).",
      "p_6_c_l1": "1. <strong>Opt-In strettamente predefinito:</strong> La telemetria è disattivata di default. Nessun dato o richiesta di rete viene trasmesso a meno che non si attivi esplicitamente l'opzione \"Condividi statistiche d'uso anonime\" nelle Impostazioni sotto Supporto e Info.",
      "p_6_c_l2": "2. <strong>Zero dati personali identificabili (Zero PII):</strong> La telemetria non raccoglie alcun identificatore personale, nome, indirizzo e-mail, indirizzo IP, peso corporeo, ripetizioni o nomi di alimenti. Gli indirizzi IP vengono scartati immediatamente al momento dell'acquisizione.",
      "p_6_c_l3": "3. <strong>Intervalli aggregati approssimativi:</strong> Le metriche degli eventi vengono raggruppate esclusivamente in intervalli approssimativi non identificabili (ad es. versione dell'app, piattaforma SO, intervalli di durata dell'allenamento come 15-30 min, numero di esercizi come 4-7, latenza richieste IA e stato migrazione database).",
      "p_6_c_l4": "4. <strong>Revoca immediata:</strong> Puoi revocare il consenso e disattivare la telemetria in qualsiasi momento nelle Impostazioni, interrompendo immediatamente ogni trasmissione.",
      "p_6_c_l5": "5. <strong>Base giuridica:</strong> Il trattamento dei dati di telemetria si basa esclusivamente sul tuo consenso esplicito ai sensi dell'Articolo 6(1)(a) del GDPR.",
      "p_6_c_l6": "6. <strong>Responsabile del trattamento:</strong> PostHog, Inc. (2261 Market St., #4008, San Francisco, CA 94114, USA) agisce in qualità di responsabile del trattamento ai sensi dell'Articolo 28 del GDPR. È stato stipulato un accordo sul trattamento dei dati (DPA).",
      "p_6_c_l7": "7. <strong>Luogo di conservazione, durata e garanzie sui trasferimenti:</strong> I dati di telemetria sono conservati esclusivamente su infrastrutture nell'UE (AWS eu-central-1, Francoforte, Germania) per un massimo di 12 mesi, trascorsi i quali vengono cancellati automaticamente. Sebbene l'archiviazione principale rimanga nell'UE, eventuali accessi di supporto tecnico da parte di PostHog, Inc. avvengono sotto le garanzie del EU-US Data Privacy Framework (DPF).",
    ...
    ja: {
      ...
      "legal_version": "バージョン 1.6",
      "legal_date": "2026年7月23日",
      ...
      "p_6_c_t": "C. オプションの匿名テレメトリ",
      "p_6_c_c1": "Train Libreは、PostHog EU（https://eu.i.posthog.com）を利用した、プライバシー重視のオプション利用統計機能を搭載しています。",
      "p_6_c_l1": "1. <strong>厳格なオプトインデフォルト：</strong> テレメトリはデフォルトで完全に無効化されています。「設定」の「サポート＆情報」で「匿用の利用統計を共有する」をオンに明示的に切替えない限り、データやネットワークリクエストが送信されることはありません。",
      "p_6_c_l2": "2. <strong>個人特定情報ゼロ（Zero PII）：</strong> テレメトリは個人識別子、名前、メールアドレス、IPアドレス、体重、レップ数、食品名を一切収集しません。IPアドレスは収集時に即座に破棄されます。",
      "p_6_c_l3": "3. <strong>おおまかな集計バケット：</strong> イベントデータは特定不能なおおまかな範囲にのみ集計されます（例：アプリバージョン、OSプラットフォーム、ワークアウト時間帯「15〜30分」、種目数範囲「4〜7」、AIリクエストのレイテンシバケット、データベース移行ステータス）。",
      "p_6_c_l4": "4. <strong>即時撤回：</strong> 設定画面でいつでも同意を撤回してテレメトリを無効化でき、すべての送信が即座に停止されます。",
      "p_6_c_l5": "5. <strong>法的根拠：</strong> テレメトリデータの処理は、GDPR第6条第1項(a)に基づくお客様の明示的な同意のみに基づいています。",
      "p_6_c_l6": "6. <strong>データ処理者：</strong> PostHog, Inc. (2261 Market St., #4008, San Francisco, CA 94114, USA) がGDPR第28条に基づくデータ処理者として機能します。データ処理契約（DPA）が締結されています。",
      "p_6_c_l7": "7. <strong>保存場所、保存期間および米国移送への安全管理措置：</strong> テレメトリデータはEU域内インフラ（AWS eu-central-1、ドイツ・フランクフルト）にのみ保存され、最長12ヶ月間保持された後、自動的に削除されます。プライマリ保存は完全にEU域内にとどまりますが、PostHog, Inc.による技術サポートアクセスの場合は「日米・EUデータプライバシーフレームワーク（DPF）」の保護措置の下で行われます。",
      "p_7_t": "7. データ主体の権利",
