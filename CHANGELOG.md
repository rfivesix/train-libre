...
- **Nutrition Hub & Recommendation Card (`NutritionHubScreen`):** Restored the 1:1 `NutritionRecommendationCard` alongside the active `GoalProgressHeroCard` in the Nutrition Hub, removed the redundant duplicate "Nutrition" body header, and removed obsolete daily operating target cards.
