...
- **Diary date strip:** The Diary header now offers a horizontally scrollable,
  ...
  layout keeps three preceding days and one following day around the active
  date, uses a compact summary-card surface for the calendar, and softly fades
  the scrollable strip at its edges.
