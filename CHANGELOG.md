...
- **Recovery tracker planning:** The separate v2 implementation plan now records the implemented core calibration, evidence boundaries, pending UI follow-up, and regression scenarios. The existing public model remains linked until that UI work is complete.
