...
*   [**Double Progression & Set-Structure Heuristic**](features/workout_progression_engine.md): The position-aware resistance-training progression model: working-set eligibility, repetition ranges, shared load-progression gate, within-workout adjustments, safeguards, and scientific limits.
