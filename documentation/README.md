...
*   [**Muscle Recovery & Readiness Model**](features/muscle_recovery_model.md): Log-based muscle readiness using per-set RIR, role-weighted exposure, different muscle decay profiles, and time-decaying residual load.
