...
- **Behavior**: If a set exceeds 12 repetitions, the estimated 1-Rep Max calculation is disabled for that set. This keeps the heuristic within its intended low-to-moderate repetition range.
