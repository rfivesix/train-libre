        ...
        NativeBarcodeScanner.requestCameraPermission { [weak self] permissionGranted in
            ...
            if permissionGranted {
                do {
                    ...
                    // IMPORTANT: FlutterStandardMethodCodec cannot encode NSError objects.
                    // Passing `error` directly as `details` causes an NSAssertionHandler
                    // crash (SIGABRT). Convert to a String first.
