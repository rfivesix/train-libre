              ...
              child: Column(
                ...
                children: [
                  TimeRangeFilter(
                    ...
                    nextEnabled: _isRolling ? true : !_activeBlock.getBounds(_anchorDate, DateTime(2020)).start.isAtSameMomentAs(_activeBlock.getBounds(DateTime.now(), DateTime(2020)).start),
